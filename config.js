...
export const firebaseConfig = {
    apiKey: import.meta.env?.VITE_FIREBASE_API_KEY || "AIzaSyA4hS3texgNpdQbjj8QIECY4n0Nl3SWwTo",
    authDomain: import.meta.env?.VITE_FIREBASE_AUTH_DOMAIN || "friez-burgz.firebaseapp.com",
    projectId: import.meta.env?.VITE_FIREBASE_PROJECT_ID || "friez-burgz",
    storageBucket: import.meta.env?.VITE_FIREBASE_STORAGE_BUCKET || "friez-burgz.firebasestorage.app",
    messagingSenderId: import.meta.env?.VITE_FIREBASE_MESSAGING_SENDER_ID || "369360939966",
    appId: import.meta.env?.VITE_FIREBASE_APP_ID || "1:369360939966:web:760d870c8c0f2a8f6667ef",
    measurementId: import.meta.env?.VITE_FIREBASE_MEASUREMENT_ID || "G-67WXCWCC2X"
};

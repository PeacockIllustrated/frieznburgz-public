...
async function renderPageContent(pageId) {
    ...
    switch (pageId) {
        ...
        case 'wastage-log':
            ...
            break;
        case 'orders':
            document.getElementById('ordersPage').innerHTML = `<h2 class="page-title">Orders</h2><p>Pending orders and order history (coming soon).</p>`;
            console.log('Rendering Orders page...');
            break;
        case 'suppliers':
            document.getElementById('suppliersPage').innerHTML = `<h2 class="page-title">Suppliers</h2><p>Manage supplier contacts (coming soon).</p>`;
